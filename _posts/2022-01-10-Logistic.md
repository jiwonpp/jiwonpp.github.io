...
첫번째 변수인 Serial No.는 단순히 데이터의 순서를 나타내기 때문에 모델 구축에 필요하지 않습니다. 따라서 input variable index는 2~8입니다.  
...
```
| model | TPR | TNR | FPR | FNR | ACC | BCR | PRE | F1 | 
|--|--|--|--|--|--|--|--|--|
|Logstic Regression|0.725|0.963|0.275 |0.038 |0.883|0.835|0.906|0.806|
